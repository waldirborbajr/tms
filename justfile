...
help:
    ...
    @echo " just version-bump patch   → Bump patch version (1.2.3 → 1.2.4)"
    @echo " just version-bump minor   → Bump minor version (1.2.3 → 1.3.0)"
    @echo " just version-bump major   → Bump major version (1.2.3 → 2.0.0)"
    @echo ""
    @echo "=== Maintenance ==="
